...
sequenceDiagram
    ...
    VersionScript->>PackageJSON: Increments 0.1.0 â†’ 0.1.1
    VersionScript->>VersionJSON: Increments 0.1.0 â†’ 0.1.1
    ...
    Android->>User: Cache invalidated âœ“
```
...
1. **First time after update:**
   ...
   - Or clear app data: Settings â†’ Apps â†’ MyTradingBox â†’ Storage â†’ Clear Data
...
1. Version increments â†’ New build hash
...
With the new setup:
- âœ… Version auto-increments on every build
- âœ… No manual version management needed
- âœ… Cache busting is automatic
- âœ… Android will always see the latest version
