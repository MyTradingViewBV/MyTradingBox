...
import {
  ...
  DrawingToolType,
  Drawing,
} from './services/drawing-tools.service';
...
@Component({
  ...
  template: `
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'horizontal-line'"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'vertical-line'"
      (click)="selectTool('vertical-line')"
      title="Verticale lijn"
    >
      <svg
        width="20"
        height="20"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'trend-line'"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'ruler'"
      (click)="selectTool('ruler')"
      title="Liniaal: meet % verandering tussen twee punten"
    >
      <svg
        width="20"
        height="20"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'long-position'"
      (click)="selectTool('long-position')"
      title="Long Positie (entry + TP + SL)"
    >
      <svg
        width="20"
        height="20"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'short-position'"
      (click)="selectTool('short-position')"
      title="Short Positie (entry + TP + SL)"
    >
      <svg
        width="20"
        height="20"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'fib-retracement'"
    ...
    <button
      class="tool-btn"
      [class.selected]="service.activeToolValue === 'fib-extension'"
    ...
    >
      ...
      <span
        >Magneet&nbsp;<span class="magneet-state">{{
          service.magnetMode === 'off'
            ? '(uit)'
            : service.magnetMode === 'weak'
              ? '(zwak)'
              : '(sterk)'
        }}</span></span
      >
    ...
    @if (service.drawingsValue.length) {
      ...
      @for (drawing of drawingsNewestFirst; track drawing.id) {
        <div
          class="drawing-row"
          [class.selected]="service.selectedDrawingId === drawing.id"
        >
          <button
            class="tool-btn drawing-select-btn"
            type="button"
      ...
      <button
        ...
        (click)="clearAll()"
        title="Verwijder alle tekeningen"
      >
        <svg
          width="20"
          height="20"
    ...
    <button
      ...
      (click)="close()"
      title="Sluit gereedschapspaneel"
    >
      <svg
        width="20"
        height="20"
